...
//        periodDuration();
    ...
    private static void dateLocal() {
        ...
        LocalDate courseEnd = LocalDate.parse("2017-07-18");// met. parse tlumaczy Stringa na format daty
        ...
        if (now.isAfter(courseStart) && now.isBefore(courseEnd)) { // && to znaczy "i"
    ...
    private static void zoned() {
        ...
        Instant now = Instant.now(); // w m. Instant przechowujemy aktulany time stamp
    ...
    private static void formatting() {
        ...
        System.out.println();
        System.out.println(now.format(DateTimeFormatter.ofPattern("dd MMM yyyy 'r.'")));// m.ofPattern
        System.out.println();
