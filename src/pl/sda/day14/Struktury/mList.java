package pl.sda.day14.Struktury;
...
public class mList {
    ...
    public void addElementAtEnd(int newElement, mList list) //dodajemy nowy element na końcu listy
    {
        Element p = new Element(); //tworzymy nowy element
        p.data = newElement; //zapisujemy wartość, którą chcemy dodać do pola data
    ...
    public Element getElementForward(int data, mList list) //metoda zwraca pierwszy element, który przechowuje
    ...
    public void printAllElements(mList list) //metoda drukuje całą listę od pierwszego elementu (głowy) do ostatniego
    // - ogona
    {
        Element p = list._head; //zaczynamy wyszukiwanie od głowy
